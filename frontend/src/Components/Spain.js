...
const emirates = [
  {
    name: "Madrid",
    image: "https://images.contentstack.io/v3/assets/blt06f605a34f1194ff/blt964a8b2f7ce2f11d/679fa8e78ccf5e47f813811f/BCC-2024-EXPLORER-MADRID-GETTING-AROUND-HEADER_MOBILE.jpg?format=webp&auto=avif&quality=60&crop=1%3A1&width=1440",
  },
  {
    name: "Barcelona",
  ...
  {
    name: "Seville",
    image: "https://lp-cms-production.imgix.net/2025-07/shutterstock2363159885.jpg?auto=format,compress&q=72&fit=crop",
  },
  {
    name: "Valencia",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4KX563YsNkoyAFlSdtsjFEu0u0tdBAUVL0A&s",
  },
  {
    name: "Granada",
    image: "https://lp-cms-production.imgix.net/2025-07/GettyImages-452680217.jpg?auto=compress&format=auto&fit=crop&q=50&w=1200&h=800",
  },
  {
    name: "Bilbao",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWk9_xmgiQmi91V6K7X2I-esFKMJDq-f1pZQ&s",
  },
  {
    name: "Malaga",
    image: "https://images.contentstack.io/v3/assets/blt06f605a34f1194ff/blt16b676a440769603/683494d4cf42ff95e90467c7/BCC-2024-EXPLORER-MALAGA-HOW-TO-AVOID-CROWDS-HEADER_MOBILE.jpg?format=webp&quality=60&width=1440",
  },
];
...
const center = {
  lat: 40.4168, // Madrid latitude
  lng: -3.7038  // Madrid longitude
};

// Nearby countries' capitals or representative coordinates
const nearbyCountries = [
  { name: 'Madrid (Spain)', lat: 40.4168, lng: -3.7038 },
  { name: 'Lisbon (Portugal)', lat: 38.7169, lng: -9.1399 },
      ...
      <div className="dubai-page">
        ...
        <div className="banner-container">
          <video autoPlay loop muted className="banner-video">
            <source src="/Videoes/spain.mp4" type="video/mp4" />
          </video>
          <div className="banner-overlay">
            <h1>Spain Visa for Indians</h1>
      ...
      {[
       ...
       <div className="visa-selection">
            ...
            <div className="visa-container">
              <h2 className="section-title">Spain Visa Requirements</h2>
  ...
  <li>💰 Income Tax Return (ITR)</li>
     <li>🏦 Last 3 months bank statements</li>
            <li>💰 Recent pay slips</li>
              ...
              {/* Visa Process */}
              <h2 className="section-title">How Spain Visa Process Works</h2>
            ...
            <div className="visa-stats-container">
              ...
              <div className="stats-section">
                <h2>Statistics on Spain Visa</h2>
              ...
              <div className="rejection-section">
                <h2>Spain Visa Rejection Reasons</h2>
...
<iframe
  ...
  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d303842.8373035531!2d-3.819620!3d40.416775!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd4229978230b17f%3A0x5c8c4c13e7a12a8!2sMadrid%2C%20Spain!5e0!3m2!1sen!2s!4v1698400000000!5m2!1sen!2s"
/>
