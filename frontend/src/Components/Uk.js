  ...
  {
    name: "London",
    image: "https://www.visitlondon.com/-/media/images/london/visit/general-london/westminster-at-dusk-london-1280x720.jpg?rev=3c05b9713c4b4405a7ab61aaeba53636&mw=800&hash=061A930869789795BC82B1A060E14562",
  },
  {
    name: "Edinburgh",
    image: "https://cdn-imgix.headout.com/media/images/e87de52c14e5ed44c472de964beb21bf-25331-EdinburghCastle-GuidedwalkingtourwithFastTrackEntry---002.jpg?auto=format&q=90&crop=faces&fit=crop",
  },
  {
    name: "Manchester",
    image: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/06/3d/31/60/manchester-town-hall.jpg?w=1400&h=1400&s=1",
  },
  {
    name: "Liverpool",
    image: "https://www.historic-uk.com/wp-content/uploads/2017/01/liverpool.jpg",
  },
  {
    name: "Birmingham",
    image: "https://a.travel-assets.com/findyours-php/viewfinder/images/res70/488000/488224-birmingham-city-centre.jpg",
  },
  {
    name: "Bristol",
    image: "https://lp-cms-production.imgix.net/2025-04/shutterstock2307485619.jpg?auto=format,compress&q=72&w=1440&h=810&fit=crop",
  },
];
 ...
 // Center of United Kingdom (London)
const center = {
...
const [activeTab, setActiveTab] = useState('sources');
      ...
      <div className="dubai-page">
        ...
        <div className="banner-container">
          <video autoPlay loop muted className="banner-video">
            <source src="/Videoes/unitedkingdom.mp4" type="video/mp4" />
          </video>
          <div className="banner-overlay">
            <h1>Unitedkingdom Visa for Indians</h1>
  ...
  <section className="visa-info mb-4">
    <h3>Unitedkingdom Visa Information</h3>
    <hr />
    <div className="row">
      {[
       ...
       <div className="visa-selection">
            ...
            <div className="visa-container">
              <h2 className="section-title">Unitedkingdom Visa Requirements</h2>
             <ul className="requirements">
             <li>📄 Passport</li>
            <li>🏦 Last 3 months bank statements</li>
            <li>💰 Recent pay slips</li>
           <li>🪪 Aadhar Card</li>
              <li>🧾 Personal ITRs (Income Tax Returns)</li>
</ul>
              ...
              {/* Visa Process */}
              <h2 className="section-title">How Unitedkingdom Visa Process Works</h2>
            ...
            <div className="visa-stats-container">
              ...
              <div className="stats-section">
                <h2>Statistics on Unitedkingdom   Visa</h2>
              ...
              <div className="rejection-section">
                <h2>Unitedkingdom   Visa Rejection Reasons</h2>
  ...
  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d19801.57936471921!2d-0.127758!3d51.507351!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48761b3339bba0ef%3A0x2b0d6b4d9c4d5b0!2sLondon%2C%20United%20Kingdom!5e0!3m2!1sen!2s!4v1698400000000!5m2!1sen!2s"
/>
