...
function Vietnam() {
 ...
 const emirates = [
  ...
  },
  {
    ...
    image:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/15/33/fb/67/ho-chi-minh-city.jpg?w=1200&h=700&s=1",
  },
  {
    name: "Ha Long Bay",
    image:
      "https://lp-cms-production.imgix.net/2023-10/GettyRF92865967.jpg?auto=format,compress&q=72&fit=crop",
  },
  {
    name: "Da Nang",
    image:
      "https://media.tacdn.com/media/attractions-splice-spp-674x446/06/74/8f/5a.jpg",
  },
  {
    name: "Hoi An",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAU55humz4l3X5fr7VbgYphQqw0dot69JeXQ&s",
  },
  {
    name: "Nha Trang",
    image:
      "https://s3.ap-southeast-1.amazonaws.com/images.tubudd.com/blog/Beach_in_Nha_Trang_Vietnam_ac910862a2.jpg",
  },
];
    ...
    <div className="dubai-page">
      ...
      <div className="banner-container">
        <video autoPlay loop muted className="banner-video">
          <source src="/Videoes/vietnam.mp4" type="video/mp4" />
        </video>
        <div className="banner-overlay">
          <h1>Vietnam Visa for Indians</h1>
...
<section className="visa-info mb-4">
  <h3>Vietnam Visa Information</h3>
  <hr />
  <div className="row">
    {[
     ...
     <div className="visa-selection">
          ...
          <div className="visa-container">
            <h2 className="section-title">Vietnam Visa Requirements</h2>
            ...
            {/* Visa Process */}
            <h2 className="section-title">How Vietnam Visa Process Works</h2>
          ...
          <div className="visa-stats-container">
            ...
            <div className="rejection-section">
              <h2>Vietnam Visa Rejection Reasons</h2>
