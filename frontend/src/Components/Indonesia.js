  ...
  {
    name: "Jakarta",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSzEcRd89EZ9ddNQ9NI3P5LwjnMHRJatQDV7A&s",
  },
  {
    name: "Mount Bromo",
  ...
  {
    name: "Komodo Island",
    image: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2f/d2/7f/fc/setelah-puluhan-tahun.jpg?w=900&h=500&s=1",
  },
  {
    name: "Ubud",
    image: "https://baliuntold.com/wp-content/uploads/2024/08/Ubud-jungle-club-terraces-pool.jpg",
  },
];
...
const [activeTab, setActiveTab] = useState('sources');
      ...
      <div className="dubai-page">
        ...
        <div className="banner-container">
          <video autoPlay loop muted className="banner-video">
            <source src="/Videoes/indonesia.mp4" type="video/mp4" />
          </video>
          <div className="banner-overlay">
            <h1>Indonesia Visa for Indians</h1>
  ...
  <section className="visa-info mb-4">
    <h3>Indonesia Visa Information</h3>
    <hr />
    <div className="row">
      {[
       ...
       <div className="visa-selection">
            ...
            <div className="visa-container">
              <h2 className="section-title">Indonesia Visa Requirements</h2>
              ...
              {/* Visa Process */}
              <h2 className="section-title">How Indonesia Visa Process Works</h2>
            ...
            <div className="visa-stats-container">
              ...
              <div className="stats-section">
                <h2>Statistics on Indonesia Visa</h2>
              ...
              <div className="rejection-section">
                <h2>Indonesia Visa Rejection Reasons</h2>
  ...
  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.743473657773!2d106.81666677479758!3d-6.208763662504517!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3e0e3a1b7f3%3A0xb8a7a8a8a8a8a8a8!2sJakarta%2C%20Indonesia!5e0!3m2!1sen!2s!4v1698400000000!5m2!1sen!2s"
/>
