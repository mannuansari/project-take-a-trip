 ...
 const emirates = [
  {
    ...
    image:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/14/24/ab/ea/a-cruise-in-victoria.jpg?w=900&h=500&s=1",
  },
  {
    name: "Hong Kong Disneyland",
    image:
      "https://live.staticflickr.com/65535/54342287809_33f4d22785_b.jpg",
  },
  {
    name: "The Peak (Victoria Peak)",
    image:
      "https://hongkongcheapo.com/wp-content/uploads/sites/7/2023/04/victoria-peak-harbour_CHUNYIP-WONG_GettyImages-1329476093.jpg",
  },
  {
    name: "Tsim Sha Tsui",
    image:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/11/fd/d0/65/night-view.jpg?w=900&h=500&s=1",
  },
  {
    name: "Lantau Island (Big Buddha)",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3iEzUYcAEchH5LtuwoEzyUDjiYO7FuTGDZQ&s",
  },
  {
    name: "Mong Kok",
    image:
      "https://i.guim.co.uk/img/media/3c1655645c104886533efaea9ad22781ef49499e/0_350_6000_3600/master/6000.jpg?width=1200&quality=85&auto=format&fit=max&s=08215b4859bce347b8a0e0841f68aac5",
  },
];
    ...
    <div className="dubai-page">
      ...
      <div className="banner-container">
        <video autoPlay loop muted className="banner-video">
          <source src="/Videoes/hong kong.mp4" type="video/mp4" />
        </video>
        <div className="banner-overlay">
          <h1>Hongkong Visa for Indians</h1>
...
<section className="visa-info mb-4">
  <h3>Hongkong Visa Information</h3>
  <hr />
  <div className="row">
    {[
     ...
     <div className="visa-selection">
          ...
          <div className="visa-container">
            <h2 className="section-title">Hongkong Visa Requirements</h2>
            ...
            {/* Visa Process */}
            <h2 className="section-title">How Hongkong Visa Process Works</h2>
          ...
          <div className="visa-stats-container">
            ...
            <div className="stats-section">
              <h2>Statistics on Hongkong Visa</h2>
            ...
            <div className="rejection-section">
              <h2>Hongkong Visa Rejection Reasons</h2>
  ...
  src="https://www.google.com/maps?q=Hong+Kong&output=embed"
/>
