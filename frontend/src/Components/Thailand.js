...
function Thailand() {
  ...
  const emirates = [
    ...
    },
    {
      ...
      image:
        "https://dynamic-media.tacdn.com/media/photo-o/30/4c/53/8a/caption.jpg?w=700&h=500&s=1",
    },
    {
      name: "Bangkok",
      image:
        "https://media.tacdn.com/media/attractions-splice-spp-674x446/12/5f/9e/bb.jpg",
    },
    {
      name: "Koh Samui",
    ...
    },
    {
      name: "Krabi",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQnCwlWvFhV6MKcDDmJJryP4Qq_NAF1AcGOyw&s",
    },
    {
      name: "Ayutthaya",
      image: "https://www.civitatis.com/f/tailandia/bangkok/guia/ayutthaya-m.jpg",
    },
  ...
  return (
    <div className="dubai-page">
      ...
      <div className="banner-container">
         <img src="https://img.freepik.com/free-photo/beautiful-girl-standing-boat-looking-mountains-ratchaprapha-dam-khao-sok-national-park-surat-thani-province-thailand_335224-849.jpg?semt=ais_hybrid&w=740&q=80"></img>
...
<section className="visa-info mb-4">
  <h3>Thailand Visa Information</h3>
  <hr />
  <div className="row">
    {[
      ...
      <div className="col-md-3 mb-2" key={idx}>
        <OverlayTrigger placement="top" overlay={<Tooltip>{item.tip}</Tooltip>}>
          ...
          {/* -------- Date Options -------- */}
        <div class="section-TDAC">
             <h2>What is TDAC ?</h2><hr/>
             <p>TDAC stands for the Thailand Digital Arrival Card, a mandatory digital process that all 
                travellers must fill before
                 travelling to Thailand. TDAC serves as an official record of the traveller's entry.</p><hr/>
                 <div class="section-take-a-trip">
                    <h2>Why Take-a-Trip?</h2><hr/>
                    <p><FaSpinner className="spin" size={24} /> Skip the Long Immigration Lines<br/>
                    Glide through immigration with a pre-approved TDAC with Atlys
                    </p><hr/>
                    <p><FaRegClock size={24} color="gray" />Hassle-Free Application<br/>
We handle the paperwork and complexity — so you don’t have to</p>
                 </div>
            ...
            <div className="timeline">
              <div className="step">
                ...
                <div className="content">
                  ...
                  <p>Submit your documents on Atlys — only pay government fee.</p>
                </div>
              </div>
              ...
              <div className="step">
                ...
                <div className="content">
                  ...
                  <p>Atlys verifies your documents and submits to Immigration.</p>
                </div>
              </div>
