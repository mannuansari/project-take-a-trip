...
const emirates = [
  ...
  {
    name: "Santorini",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTrTRLFwTZCgsBNh0sLGc_QOPTywWmvU7j8jA&s",
  },
  {
    name: "Mykonos",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbo9YTta2VZNiDvZ2LnMNlALIeu09U9X8d9w&s",
  },
  {
    name: "Thessaloniki",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/White_Tower_and_Beach_front.jpg/330px-White_Tower_and_Beach_front.jpg",
  },
  {
    name: "Crete",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZHvsAW3VTHptxARt_LqFbKBCusNNbVzkfTg&s",
  },
  {
    name: "Rhodes",
    image: "https://cdn.britannica.com/65/114965-050-3C4F95F4/citadel-acropolis-Lindos-Greeks-Romans-Byzantines-Ottomans.jpg",
  },
  {
    name: "Corfu",
    image: "https://www.telegraph.co.uk/content/dam/Travel/Destinations/Oceania/Australia/Perth/corfu-GettyImages-1362573792.jpg?imwidth=640",
  },
];
      ...
      <div className="dubai-page">
        ...
        <div className="banner-container">
          <video autoPlay loop muted className="banner-video">
            <source src="/Videoes/greece.mp4" type="video/mp4" />
          </video>
          <div className="banner-overlay">
            <h1>Greece Visa for Indians</h1>
      ...
      {[
       ...
       <div className="visa-selection">
            ...
            <div className="visa-container">
              <h2 className="section-title">Greece Visa Requirements</h2>
  ...
  <li>💰 Income Tax Return (ITR)</li>
     <li>🏦 Last 3 months bank statements</li>
            <li>💰 Recent pay slips</li>
              ...
              {/* Visa Process */}
              <h2 className="section-title">How Greece Visa Process Works</h2>
            ...
            <div className="visa-stats-container">
              ...
              <div className="stats-section">
                <h2>Statistics on Greece Visa</h2>
              ...
              <div className="rejection-section">
                <h2>Greece Visa Rejection Reasons</h2>
...
<iframe
  ...
  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d315246.2456385428!2d23.580014!3d37.983810!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14a1bd2b88b6a8b9%3A0x400bd2ce2b974c0!2sAthens%2C%20Greece!5e0!3m2!1sen!2s!4v1698400000000!5m2!1sen!2s"
/>
