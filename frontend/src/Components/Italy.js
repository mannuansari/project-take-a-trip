...
const emirates = [
  ...
  {
    name: "Venice",
    image: "https://thegapdecaders.com/wp-content/uploads/2022/11/Venice1.jpg.webp",
  },
  {
    name: "Milan",
  ...
  {
    name: "Naples",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgH2vhMVFT5gfvpiIINGFXAkD37F42O9oSDg&s",
  },
  {
    name: "Pisa",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSVf9YIwPca6XLnX5y-WEaNvG_f5THavWjZpg&s",
  },
  {
    name: "Turin",
    image: "https://www.aqtocycling.com/wp-content/uploads/AQTO-Cycling-Turin-with-the-Alps-in-the-background.jpg",
  },
];
...
// Center of Italy (Rome)
const center = {
  lat: 41.9028, // Rome latitude
  lng: 12.4964  // Rome longitude
};
      ...
      <div className="dubai-page">
        ...
        <div className="banner-container">
          <video autoPlay loop muted className="banner-video">
            <source src="/Videoes/italy.mp4" type="video/mp4" />
          </video>
          <div className="banner-overlay">
            <h1>Italy Visa for Indians</h1>
...
<ul className="requirements">
  ...
  <li> </li>
              ...
              {/* Visa Process */}
              <h2 className="section-title">How Italy Visa Process Works</h2>
            ...
            <div className="visa-stats-container">
              ...
              <div className="stats-section">
                <h2>Statistics on Italy Visa</h2>
              ...
              <div className="rejection-section">
                <h2>Italy Visa Rejection Reasons</h2>
...
<iframe
  ...
  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d377572.8399328469!2d12.238004!3d41.9027835!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x132f61936f1c5e01%3A0x66f48b1a6d45a8f3!2sRome%2C%20Italy!5e0!3m2!1sen!2s!4v1698400000000!5m2!1sen!2s"
/>
