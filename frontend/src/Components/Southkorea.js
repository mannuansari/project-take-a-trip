...
const emirates = [
  {
    name: "Seoul",
    image: "https://images.contentstack.io/v3/assets/blt06f605a34f1194ff/blt1bee36a8af145afa/67c03a3fc1fe96c5ca54e61d/BCC-2024-EXPLORER-SEOUL-THINGS-TO-DO-AT-NIGHT-HEADER_MOBILE.jpg?format=webp&quality=60&width=1440",
  },
  {
    name: "Busan",
    image: "https://res.klook.com/image/upload/fl_lossy.progressive,q_60/v1755345966/destination/wbgdzlhksoqhm3htppmc.jpg",
  },
  {
    name: "Jeju Island",
    image: "https://media.tacdn.com/media/attractions-splice-spp-674x446/16/9d/10/62.jpg",
  },
  {
    name: "Incheon",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPDXYG_bpfhQOyP3Ty-3omIajU21DcZovcow&s",
  },
  {
    name: "Gyeongju",
    image: "https://res.klook.com/image/upload/fl_lossy.progressive,q_60/Mobile/City/hhlxl34db2cl9rnbfuvr.jpg",
  },
  {
    name: "Daegu",
    image: "https://cdn.sanity.io/images/nxpteyfv/goguides/92673728ea72298df85c3de19ac7a56e6e31ad8e-1600x1066.jpg",
  },
  {
    name: "Daejeon",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSDA6aCTo9EW-wepLrCy967N88saLWY6a7L9A&s",
  },
];
...
// Center of South Korea (Seoul)
const center = {
  lat: 37.5665, // Seoul latitude
  lng: 126.9780 // Seoul longitude
};
...
const nearbyCountries = [
  ...
  { name: 'Ulaanbaatar (Mongolia)', lat: 47.9212, lng: 106.9186 },
...
const [activeTab, setActiveTab] = useState('sources');
      ...
      <div className="dubai-page">
        ...
        <div className="banner-container">
          <video autoPlay loop muted className="banner-video">
            <source src="/Videoes/southkorea.mp4" type="video/mp4" />
          </video>
          <div className="banner-overlay">
            <h1>Southkorea Visa for Indians</h1>
  ...
  <section className="visa-info mb-4">
    <h3> South korea Visa Information</h3>
    <hr />
    <div className="row">
      {[
       ...
       <div className="visa-selection">
            ...
            <div className="visa-container">
              <h2 className="section-title">South korea Visa Requirements</h2>
<ul className="requirements">
  <li>📄 Passport</li>
  <li>🏦 Last 3 months bank statements</li>
  <li>✈️ Flight Details</li>
  <li>🏨 Hotel Details</li>
</ul>
              ...
              {/* Visa Process */}
              <h2 className="section-title">How South Korea Visa Process Works</h2>
            ...
            <div className="visa-stats-container">
              ...
              <div className="stats-section">
                <h2>Statistics on South Korea Visa</h2>
              ...
              <div className="rejection-section">
                <h2>South Korea Visa Rejection Reasons</h2>
...
<iframe
  ...
  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31682.419203778073!2d126.978291!3d37.566535!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca2f59c1b1e4b%3A0x15c4d8b1fefb4a11!2sSeoul%2C%20South%20Korea!5e0!3m2!1sen!2s!4v1698400000000!5m2!1sen!2s"
/>
