    ...
    <div className="dubai-page">
      ...
      <div className="banner-container">
        <video autoPlay loop muted className="banner-video">
          <source src="/Videoes/azerbaijan1.mp4" type="video/mp4" />
        </video>
        <div className="banner-overlay">
          <h1>Azerbaijan Visa for Indians</h1>
...
<section className="visa-info mb-4">
  <h3>Azerbaijan Visa Information</h3>
  <hr />
  <div className="row">
    {[
     ...
     <div className="visa-selection">
          ...
          <div className="visa-container">
            <h2 className="section-title">Azerbaijan Visa Requirements</h2>
            ...
            {/* Visa Process */}
            <h2 className="section-title">How Azerbaijan Visa Process Works</h2>
          ...
          <div className="visa-stats-container">
            ...
            <div className="stats-section">
              <h2>Statistics on Azerbaijan Visa</h2>
            ...
            <div className="rejection-section">
              <h2>Azerbaijan Visa Rejection Reasons</h2>
  ...
  <iframe
    ...
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29793.47697193187!2d49.8231!3d40.4093!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40307d27c9c08aaf%3A0x6a2b7d30a8caa9e1!2sBaku%2C%20Azerbaijan!5e0!3m2!1sen!2s!4v1698400000000!5m2!1sen!2s"
  ></iframe>
</div>
