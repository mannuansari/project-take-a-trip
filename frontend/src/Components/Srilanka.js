...
function Srilanka() {
 ...
 const emirates = [
  ...
  },
  {
    name: "Kandy",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqDlSH4jL1oER8a7i65N0Sqh_GmSuZn24sMA&s",
  },
  {
    name: "Galle",
    image:
      "https://i.ytimg.com/vi/r--5AUP4r7g/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLAUAdZJkXNaXKA8R9AFf8dh0S-JxQ",
  },
  {
    name: "Nuwara Eliya",
    image:
      "https://cdn.shopify.com/s/files/1/0265/8710/3329/files/15979547-female-worker-at-tea-plantation-nuwara-eliya-sri-lanka_large.jpg?v=1577073410",
  },
  {
    name: "Sigiriya",
    image:
      "https://www.biofin.org/sites/default/files/content/news_media/Screenshot%202564-08-02%20at%2010.14.55.png",
  },
  {
    name: "Bentota",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-XUjkCKnHB_kuv2ras8yRRZ059KF0RAFsRA&s",
  },
];
...
const nearbyCountries = [
  ...
  { name: 'Yangon (Myanmar)', lat: 16.8409, lng: 96.1735 },
    ...
    <div className="dubai-page">
      ...
      <div className="banner-container">
        <video autoPlay loop muted className="banner-video">
          <source src="/Videoes/srilanka.mp4" type="video/mp4" />
        </video>
        <div className="banner-overlay">
          <h1>Srilanka Visa for Indians</h1>
...
<section className="visa-info mb-4">
  <h3>Srilanka Visa Information</h3>
  <hr />
  <div className="row">
    {[
     ...
     <div className="visa-selection">
          ...
          <div className="visa-container">
            <h2 className="section-title">Srilanka Visa Requirements</h2>
            ...
            {/* Visa Process */}
            <h2 className="section-title">How Srilanka Visa Process Works</h2>
          ...
          <div className="visa-stats-container">
            ...
            <div className="stats-section">
              <h2>Statistics on Vietnam Visa</h2>
            ...
            <div className="rejection-section">
              <h2>Srilanka Visa Rejection Reasons</h2>
